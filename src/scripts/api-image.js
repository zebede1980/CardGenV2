...
BEGIN PROMPT:`;
  ...
  // No mask — this edits the whole image.
  ...
  // catalog). This is NOT the same request shape as editImage(): per
  // nano-gpt's docs, multi-reference calls use a distinct endpoint
